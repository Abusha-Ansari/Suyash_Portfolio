...
export function Footer() {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/SuyashGargote", label: "GitHub" },
    {
      icon: Linkedin,
      href: "https://www.linkedin.com/in/suyash-gargote-a1585b251",
      label: "LinkedIn",
    },
    { icon: Twitter, href: "https://x.com/GargoteSuyash", label: "Twitter" },
      ...
      <div className="container px-4 mx-auto py-12">
          ...
          <div className="md:col-span-2">
            ...
            >
              ...
              <p className="text-muted-foreground max-w-md leading-relaxed">
                Passionate Developer & Cybersecurity Enthusiast dedicated to
                creating secure, innovative digital solutions. Always learning,
                always building.
              </p>
            </motion.div>
          ...
          <div>
            ...
            >
              ...
              <div className="space-y-2 text-muted-foreground">
                <p>Thane, Maharastra, India</p>
                <p>suyashgargote26@email.com</p>
                <p>+91 7977603364</p>
              </div>
            </motion.div>
          </div>
        ...
        >
          <div className="flex items-center space-x-2 text-muted-foreground">
            <span>© {currentYear} Suyash Gargote. Made with</span>
